        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4 items-center">
              <a href="https://wa.me/79892285629" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">
                <Icon name="MessageCircle" size={24} />
              </a>
              <a href="https://t.me/+79892285629" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">
                <Icon name="Send" size={24} />
              </a>
              <a href="mailto:4768284slava@mail.ru" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">
                <Icon name="Mail" size={24} />
              </a>
              <a href="tel:+79892285629" className="text-gray-400 hover:text-purple-400 transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="#products"
                  className="font-space-mono text-gray-400 hover:text-purple-400 transition-colors duration-200"
                >
                  Перегородки
                </a>
              </li>
